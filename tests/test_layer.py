...
class TestLayer(TestCase):
    ...
    def test_dCost_dW_output_layer(self):
        ...
        assert_array_equal(expected_dCost_dW, self.output_layer_2._dCost_dW().round(3))

    def test_dCost_dB_output_layer(self):
        self.activate_layers_2()
        expected_dCost_dB = np.array(0.042)
        assert_array_equal(expected_dCost_dB, self.output_layer_2._dCost_dB().round(3))
    ...
    def test_dCost_dW_hidden_layer(self):
        ...
        expected_dCost_dW = np.array([[0.0004, 0.0005],
                                      [0.0016, 0.0019],
                                      [0.0027, 0.0034]])
        assert_array_equal(expected_dCost_dW, self.hidden_layer_2._dCost_dW().round(4))
    ...
    def test_dCost_dB_hidden_layer(self):
        ...
        expected_dCost_dB = np.array([[0.001],
                                      [0.004],
                                      [0.008]])
        assert_array_equal(expected_dCost_dB, self.hidden_layer_2._dCost_dB().round(3))
    ...
    def test_second_iteration(self):
        ...
        expected_hidden_dCost_dB = np.array([[0.001],
                                             [0.003],
                                             [0.007]])
        assert_array_equal(expected_output_dCost_dW, self.output_layer_2._dCost_dW().round(3))
        assert_array_equal(expected_output_dCost_dB, self.output_layer_2._dCost_dB().round(3))
        assert_array_equal(expected_hidden_dCost_dW, self.hidden_layer_2._dCost_dW().round(3))
        assert_array_equal(expected_hidden_dCost_dB, self.hidden_layer_2._dCost_dB().round(3))
    ...
    def test_randomise_and_activate(self):
        ...
        self.hidden_layer_2.activate()
        self.output_layer_2.activate()
        expected_activation = np.array([[0.73, 0.75, 0.75, 0.76]])
        assert_array_equal(expected_activation, self.output_layer_2.activation.round(2))
